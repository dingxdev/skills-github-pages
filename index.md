...
d1开发了该[开源的/免费的/含有内购的/含有广告赞助的/商业的]应用程序[令人惊奇的应用]。该服务由d1提供，旨在安装并使用。

我对您使用[令人惊奇的应用]的隐私政策做出规定，并解释了我如何收集，保护和披露您因使用我的服务而产生的信息。

如果您选择使用我提供的服务，则表示您同意收集和使用与此政策相关的信息。我收集的个人信息用于提供和改进服务。除非本隐私政策中另有说明，否则我不会与任何人一起使用或分享您的信息。

除非本隐私政策另有规定，否则本隐私政策中使用的术语与我们的条款和条件具有相同的含义，可在[令人惊奇的应用]中访问。
...
如果您对我的隐私政策有任何疑问或建议，请随时通过[联系方式]与我联系。
